...
class LogMessageDecoderTest {
    ...
    Test fun ShouldDecodeTcpSynLog(){
        ...
        Assert.assertEquals("100.64.0.100", result.src.getHostAddress())
        Assert.assertEquals(58105, result.srcPort)
        Assert.assertEquals("217.107.214.29", result.dst.getHostAddress())
    ...
    Test fun ShouldDecodeUdpLog(){
        ...
        Assert.assertEquals("100.64.0.131", result.src.getHostAddress())
        Assert.assertEquals(34308, result.srcPort)
        Assert.assertEquals("178.236.142.83", result.dst.getHostAddress())
    ...
    Test fun ShouldDecodeIcmpLog(){
        ...
        Assert.assertEquals("100.64.0.213", result.src.getHostAddress())
        Assert.assertEquals(0, result.srcPort)
        Assert.assertEquals("77.234.40.55", result.dst.getHostAddress())
    ...
    Test fun ShouldDecodeProto41Log(){
        ...
        Assert.assertEquals("100.64.0.11", result.src.getHostAddress())
        Assert.assertEquals(0, result.srcPort)
        Assert.assertEquals("93.185.249.146", result.dst.getHostAddress())
        Assert.assertEquals(0, result.dstPort)
    }
    ...
    Test fun ShouldDecodeTcpAckLog(){
        ...
        Assert.assertEquals("100.64.0.127", result.src.getHostAddress())
        Assert.assertEquals(51747, result.srcPort)
        Assert.assertEquals("217.20.147.94", result.dst.getHostAddress())
        Assert.assertEquals(80, result.dstPort)
    }
    ...
    Test fun ShouldDecodeTcpAckPshLog(){
        ...
        Assert.assertEquals("100.64.0.165", result.src.getHostAddress())
        Assert.assertEquals(56566, result.srcPort)
        Assert.assertEquals("173.194.32.166", result.dst.getHostAddress())
